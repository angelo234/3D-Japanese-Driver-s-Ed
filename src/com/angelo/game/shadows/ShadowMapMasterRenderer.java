...
public class ShadowMapMasterRenderer {
	...
	private ShadowMapCarRenderer carRenderer;
	private ShadowMapLineRenderer lineRenderer;
	...
	public ShadowMapMasterRenderer(Camera camera) {
		...
		carRenderer = new ShadowMapCarRenderer(shader, projectionViewMatrix);
		lineRenderer = new ShadowMapLineRenderer(shader, projectionViewMatrix);
	}
	 ...
	 */
	public void render(Map<TexturedModel, List<Entity>> entities, Map<TexturedModel[], List<Car>> cars, List<Line> lines, Light sun) {
		shadowBox.update();
