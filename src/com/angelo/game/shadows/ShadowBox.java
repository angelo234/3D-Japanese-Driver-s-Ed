...
public class ShadowBox {
	...
	private Matrix4f calculateCameraRotationMatrix() {
		...
		rotation.rotate((float) Math.toRadians(-cam.getRotation().getY()), new Vector3f(0, 1, 0));
		rotation.rotate((float) Math.toRadians(-cam.getRotation().getX()), new Vector3f(1, 0, 0));
		return rotation;
	}
