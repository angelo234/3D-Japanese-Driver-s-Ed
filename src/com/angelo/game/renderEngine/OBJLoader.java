...
public class OBJLoader {
	...
	public static String getObjModelFromScenario(String fileName){
		String loc = ScenarioLoader.OBJECT_FOLDER+fileName;
		return loc;
	}
	
	public static RawModel loadObjModelFromScenario(String fileName){
		FileReader fr = null;
		try {
			fr = new FileReader(new File(ScenarioLoader.OBJECT_FOLDER+fileName));
		} catch (FileNotFoundException e) {
			System.err.println("Couldn't find file: "+fileName);
			e.printStackTrace();
		}
